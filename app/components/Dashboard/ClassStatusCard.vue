...
.progress-note { margin-top: 6px; font-size: var(--md3-label-medium); color: rgb(var(--mdui-color-on-surface-variant)); }
.today-lessons { margin-top: 10px; padding-top: 10px; border-top: 1px solid color-mix(in srgb, rgb(var(--mdui-color-outline-variant)) 38%, transparent 62%); }
.today-lesson-list { margin-top: 8px; border-radius: 12px; background: color-mix(in srgb, rgb(var(--mdui-color-surface-container-high)) 58%, transparent 42%); overflow: hidden; }
.today-lesson-item { display: flex; align-items: center; justify-content: space-between; gap: 10px; width: 100%; padding: 8px 0; line-height: 1.7; font-size: var(--md3-body-medium); color: rgb(var(--mdui-color-on-surface)); }
.compact-tip { margin-top: 6px; }
.lesson-toggle-btn { margin-top: 4px; }
